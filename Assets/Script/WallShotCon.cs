...
public class WallShotCon : MonoBehaviour
{
        ...
        {
            {
                ...
                wallShot.transform.rotation = Quaternion.Euler(0, 0, wallShotAngle + 260);
    ...
    IEnumerator wallSouceTP()
    {
        ...
        while (StatsInfo.Enm1_HP < 100)
        {
            ...
            if (distance.magnitude > 15)      //一定以上離れていたら移動許可
            {
